...
"""
REALISER UNE CALCULATRICE EN PYTHON TKINTER.
"""
...
text_resultat=tk.Text(root,height=2, width=14,font=('Arial',24))
...
btn_multi=tk.Button(root,text="x",command=lambda:ajout_calcul('*'),width=5,font=('Arial',14))
...
btn_effacer=tk.Button(root,text="C",command=effacer_ecran,width=5,font=('Arial',14))
